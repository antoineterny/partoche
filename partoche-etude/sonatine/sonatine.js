...
const playlist = [
  { titre: "sonatineA", description: "Sonatine en sol majeur (I) - passage A" },
  { titre: "sonatineB", description: "Sonatine en sol majeur (I) - passage B" },
  { titre: "sonatineC", description: "Sonatine en sol majeur (I) - passage C" },
  { titre: "sonatineD", description: "Sonatine en sol majeur (I) - passage D" },
  { titre: "sonatineE", description: "Sonatine en sol majeur (I) - passage E" },
  { titre: "sonatineF", description: "Sonatine en sol majeur (I) - passage F" },
];
let index = 0;
